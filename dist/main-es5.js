...
var PlanexpirytrackingComponent = /** @class */ (function () {
    function PlanexpirytrackingComponent(apiCall, excelservice, router) {
    ...
    PlanexpirytrackingComponent.prototype.getClients = function () {
        var _this = this;
        var partner_id = { partner_id: this.partner_id };
        this.apiCall.getplanexpirycontactsAll(partner_id).subscribe(function (res) {
            _this.personList = res.data;
        });
    };
    PlanexpirytrackingComponent.prototype.getPartnerData = function () {
        var _this = this;
        this.apiCall.getPartnerData().subscribe(function (res) {
            _this.partnerData = res.result;
            console.log(_this.partnerData);
        });
    };
    ...
    PlanexpirytrackingComponent.prototype.getclientsbyfilter = function (value) {
        var _this = this;
        console.log(value);
    ...
    PlanexpirytrackingComponent.prototype.selectAllToppings = function (checked, toppings) {
    ...
    PlanexpirytrackingComponent.prototype.selectNewTopping = function (checked, topping) {
        if (checked) {
    ...
    PlanexpirytrackingComponent.prototype.selectclients = function () {
        var notify = confirm("Are you sure you want to send notification");
        if (notify) {
...
var SendpushnotificationComponent = /** @class */ (function () {
    function SendpushnotificationComponent(apiCall, router) {
        this.apiCall = apiCall;
        this.router = router;
        this.boolean = false;
    }
    SendpushnotificationComponent.prototype.ngOnInit = function () {
        this.getMyContacts();
    };
    SendpushnotificationComponent.prototype.getMyContacts = function () {
        var _this = this;
        this.apiCall.client_idArray.subscribe(function (res) {
            if (res === void 0) { res = []; }
            _this.client_ids = res.map(function (el) { return el.client_id; });
            _this.mobilenumbers = res.map(function (el) { return el.user_mobile_number; });
        });
    };
    SendpushnotificationComponent.prototype.pushnotify = function (data) {
        var _this = this;
        data.client_ids = this.client_ids;
        data.mobilenumbers = this.mobilenumbers;
        console.log(data);
        if (this.boolean) {
            this.apiCall.insertnotifications(data).subscribe(function (res) {
                console.log(res);
        ...
        this.apiCall.sendPushnotifySMS(data).subscribe(function (res) {
            console.log(res);
            if (res.type == 'success') {
    ...
    SendpushnotificationComponent.prototype.checkbox = function (event) {
        console.log(event);
        this.boolean = event;
    };
    SendpushnotificationComponent.ctorParameters = function () { return [
        { type: src_app_apiCalls_api_call_service__WEBPACK_IMPORTED_MODULE_3__["ApiCallService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var DigitalcardsComponent = /** @class */ (function () {
    function DigitalcardsComponent() {
    }
    DigitalcardsComponent.prototype.ngOnInit = function () {
    };
...
var Vcard01Component = /** @class */ (function () {
    function Vcard01Component() {
    }
    Vcard01Component.prototype.ngOnInit = function () {
    };
    Vcard01Component.prototype.share = function (data) {
        console.log(data);
...
var Vcard02Component = /** @class */ (function () {
    function Vcard02Component() {
    }
    Vcard02Component.prototype.ngOnInit = function () {
    };
    Vcard02Component.prototype.share = function (data) {
        console.log(data);
        var message = "this is test message";
        // Opening URL
        window.open('https://api.whatsapp.com/send?text=' + message + '&phone=' + '+91' + this.mobilenumber);
...
var Vcard03Component = /** @class */ (function () {
    function Vcard03Component() {
    }
    Vcard03Component.prototype.ngOnInit = function () {
    };
    Vcard03Component.prototype.share = function (data) {
        console.log(data);
        var message = "this is test message";
        // Opening URL
        window.open('https://api.whatsapp.com/send?text=' + message + '&phone=' + '+91' + this.mobilenumber);
...
var ViewdigitalcardsComponent = /** @class */ (function () {
    function ViewdigitalcardsComponent() {
    }
    ViewdigitalcardsComponent.prototype.ngOnInit = function () {
    };
    ViewdigitalcardsComponent.prototype.share = function (data) {
        console.log(data);
        var message = "this is test message";
        // Opening URL
        window.open('https://api.whatsapp.com/send?text=' + message + '&phone=' + '+91' + this.mobilenumber);
    ...
    return ViewdigitalcardsComponent;
}());
...
var ResellerviewComponent = /** @class */ (function () {
    function ResellerviewComponent(apiCall, excelservice, router) {
        this.apiCall = apiCall;
        this.excelservice = excelservice;
        this.router = router;
        this.awaitingPersonList = [];
    ...
    ResellerviewComponent.prototype.ngOnInit = function () {
        this.role = this.apiCall.getRole();
        this.getClients();
    };
    ResellerviewComponent.prototype.updateList = function (id, property, event) {
        var editField = event.target.textContent;
        this.personList[id][property] = editField;
    };
    ResellerviewComponent.prototype.remove = function (id) {
        this.awaitingPersonList.push(this.personList[id]);
        this.personList.splice(id, 1);
    };
    ResellerviewComponent.prototype.add = function () {
        if (this.awaitingPersonList.length > 0) {
            var person = this.awaitingPersonList[0];
            this.personList.push(person);
            this.awaitingPersonList.splice(0, 1);
    ...
    ResellerviewComponent.prototype.changeValue = function (id, property, event) {
        this.editField = event.target.textContent;
    };
    ResellerviewComponent.prototype.getClients = function () {
        var _this = this;
        this.apiCall.getClients().subscribe(function (res) {
            console.log(res);
            _this.personList = res.data;
    ...
    ResellerviewComponent.prototype.deleteclient = function (client_id, id) {
        var _this = this;
        console.log(id);
        var yes = confirm('Are you sure want to Delete?');
        if (yes) {
    ...
    ResellerviewComponent.prototype.exportAsXLSX = function () {
        this.excelservice.exportAsExcelFile(this.personList, 'sample');
    };
    ResellerviewComponent.prototype.updatestatus = function (person) {
    ...
    ResellerviewComponent.prototype.getclientsbyfilter = function (value) {
        var _this = this;
        console.log(value);
    ...
    ResellerviewComponent.prototype.selectAllToppings = function (checked, toppings) {
        this.selectedToppings = toppings;
        if (checked) {
            this.allToppings = true;
            this.selectedclients = this.selectedToppings;
    ...
    ResellerviewComponent.prototype.selectNewTopping = function (checked, topping) {
        if (checked) {
            this.selectedToppings.push(topping);
            this.selectedclients = this.selectedToppings;
        }
    ...
    ResellerviewComponent.prototype.selectclients = function () {
        var notify = confirm("Are you sure you want to send Bulksms");
        if (notify) {
            this.apiCall.getclientids(this.selectedclients);
            this.router.navigate(['/client/sendbulksms']);
        }
    };
    ResellerviewComponent.ctorParameters = function () { return [
        { type: src_app_apiCalls_api_call_service__WEBPACK_IMPORTED_MODULE_3__["ApiCallService"] },
...
var ApiCallService = /** @class */ (function () {
    ...
    ApiCallService.prototype.getclientids = function (client_idArray) {
        this.clientSource.next(client_idArray);
    };
    ApiCallService.prototype.confirmpackage = function (packData) {
    ...
    ApiCallService.prototype.uploadapk = function (title, profileImage, partner_id) {
        var formData = new FormData();
        formData.append('title', title);
        formData.append('avatar', profileImage);
    ...
    ApiCallService.prototype.getplanexpirycontactsAll = function (data) {
    ...
    ApiCallService.prototype.getuserdataCount = function () {
    ...
    ApiCallService.prototype.userdataCountweekly = function () {
    ...
    ApiCallService.prototype.getplanexpirytoday = function () {
    ...
    ApiCallService.prototype.getplanexpirynextweek = function () {
    ...
    ApiCallService.prototype.getrateCards = function () {
    ...
    ApiCallService.prototype.getpacksbyratecard = function (data) {
    ...
    ApiCallService.prototype.getPremiumRatecards = function () {
    ...
    ApiCallService.prototype.getPremiumpacksByRateCard = function (data) {
    ...
    ApiCallService.prototype.sendpushnotification = function (data) {
    ...
    ApiCallService.prototype.sendPushnotifySMS = function (data) {
    ...
    ApiCallService.prototype.sendSingleSMS = function (data) {
    ...
    ApiCallService.prototype.getPartnerData = function () {
...
var ApkuploadsComponent = /** @class */ (function () {
    ...
    ApkuploadsComponent.prototype.submitForm = function () {
        var _this = this;
        this.apiCall.uploadapk(this.form.value.title, this.form.value.avatar, this.apiCall.getPartner_id()).subscribe(function (event) {
            switch (event.type) {
                case _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpEventType"].Sent:
                    console.log('Request has been made!');
                    break;
...
var CampaignManagementComponent = /** @class */ (function () {
    function CampaignManagementComponent(apiCall, excelservice, router) {
        this.apiCall = apiCall;
        this.excelservice = excelservice;
        this.router = router;
        this.awaitingPersonList = [];
    ...
    CampaignManagementComponent.prototype.selectAllToppings = function (checked, toppings) {
        this.selectedToppings = toppings;
        if (checked) {
            this.allToppings = true;
            this.selectedclients = this.selectedToppings;
    ...
    CampaignManagementComponent.prototype.selectclients = function () {
        var notify = confirm("Are you sure you want to send notification");
        if (notify) {
            this.apiCall.getclientids(this.selectedclients);
...
var PushnotifyComponent = /** @class */ (function () {
    ...
    PushnotifyComponent.prototype.getrateCards = function () {
        var _this = this;
        this.apiCall.getrateCards().subscribe(function (res) {
            console.log(res);
            _this.smspackratecards = res.result;
        });
    };
    PushnotifyComponent.prototype.getpacksbyratecard = function (data) {
        var _this = this;
        var userData = { ratecard_id: data };
        this.apiCall.getpacksbyratecard(userData).subscribe(function (res) {
            console.log(res);
            _this.personList = res.result;
            _this.smspackage_ratecard = res.result[0].ratecard_id;
            console.log(_this.smspackage_ratecard);
            _this.premiumpacks = '';
            if (res.status == 'false') {
                alert(res.message);
            }
    ...
    PushnotifyComponent.prototype.getPremiumRatecards = function () {
        var _this = this;
        this.apiCall.getPremiumRatecards().subscribe(function (res) {
            console.log(res);
            _this.premiumpackratecards = res.result;
        });
    };
    PushnotifyComponent.prototype.getPremiumpacksByRateCard = function (data) {
        var _this = this;
        var userData = { ratecard_id: data };
        this.apiCall.getPremiumpacksByRateCard(userData).subscribe(function (res) {
            _this.premiumpacks = res.result;
            console.log(res);
            _this.premiumplan_ratecard = res.result[0].ratecard_id;
            console.log(_this.premiumplan_ratecard);
            _this.personList = '';
        });
    };
    PushnotifyComponent.prototype.getMyContacts = function () {
        var _this = this;
        this.apiCall.client_idArray.subscribe(function (res) {
            if (res === void 0) { res = []; }
            _this.clientsData = res;
        });
    };
    PushnotifyComponent.prototype.confirmpackages = function (data) {
...
var SendnotificationComponent = /** @class */ (function () {
    function SendnotificationComponent(apiCall, router) {
        this.apiCall = apiCall;
        this.router = router;
        this.boolean = false;
    }
    ...
    SendnotificationComponent.prototype.getMyContacts = function () {
        var _this = this;
        this.apiCall.packArray.subscribe(function (res) {
            if (res === void 0) { res = []; }
            _this.client_ids = res.userData.clientdata.map(function (el) { return el.client_id; });
            _this.mobilenumbers = res.userData.clientdata.map(function (el) { return Number(el.user_mobile_number); });
            _this.smspackage_ratecard = res.userData.smspackage_ratecard;
            _this.premiumplan_ratecard = res.userData.premiumplan_ratecard;
            console.log(_this.premiumplan_ratecard, _this.smspackage_ratecard);
        });
    };
    SendnotificationComponent.prototype.pushnotify = function (data) {
        var _this = this;
        data.client_ids = this.client_ids;
        data.mobilenumbers = this.mobilenumbers;
        ...
        console.log(data);
        if (this.boolean) {
            this.apiCall.sendpushnotification(data).subscribe(function (res) {
                console.log(res);
                if (res.status == 'success') {
                    alert(res.message);
                    _this.router.navigate(['/campaignManage']);
                }
                else {
                    alert(res.message);
                }
    ...
    SendnotificationComponent.prototype.checkbox = function (event) {
        console.log(event);
        this.boolean = event;
    };
    SendnotificationComponent.ctorParameters = function () { return [
        { type: src_app_apiCalls_api_call_service__WEBPACK_IMPORTED_MODULE_3__["ApiCallService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var SendbulksmsComponent = /** @class */ (function () {
    function SendbulksmsComponent(apiCall, router, route) {
        this.apiCall = apiCall;
        this.router = router;
        this.route = route;
        this.boolean = false;
    }
    SendbulksmsComponent.prototype.ngOnInit = function () {
        this.getMyContacts();
    };
    SendbulksmsComponent.prototype.sendsms = function (data) {
        var _this = this;
        data.mobilenumbers = this.mobilenumbers;
        this.apiCall.sendPushnotifySMS(data).subscribe(function (res) {
            console.log(res);
    ...
    SendbulksmsComponent.prototype.getMyContacts = function () {
        var _this = this;
        this.apiCall.client_idArray.subscribe(function (res) {
            if (res === void 0) { res = []; }
            _this.mobilenumbers = res.map(function (el) { return Number(el.user_mobile_number); });
            console.log(_this.mobilenumbers);
        });
    };
    SendbulksmsComponent.ctorParameters = function () { return [
        { type: src_app_apiCalls_api_call_service__WEBPACK_IMPORTED_MODULE_3__["ApiCallService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
    ]; };
...
var SendsmstoclientsComponent = /** @class */ (function () {
    function SendsmstoclientsComponent(apiCall, router, route) {
        this.apiCall = apiCall;
        this.router = router;
        this.route = route;
        this.boolean = false;
    }
    SendsmstoclientsComponent.prototype.ngOnInit = function () {
        this.mobilenumbers = this.route.snapshot.paramMap.get('mobilenumber');
    };
    SendsmstoclientsComponent.prototype.sendsms = function (data) {
        var _this = this;
        data.mobilenumbers = this.mobilenumbers;
        this.apiCall.sendSingleSMS(data).subscribe(function (res) {
            console.log(res);
            if (res.type == 'success') {
                alert('sms sent successfully');
                _this.router.navigate(['/home']);
    ...
    SendsmstoclientsComponent.ctorParameters = function () { return [
        { type: src_app_apiCalls_api_call_service__WEBPACK_IMPORTED_MODULE_3__["ApiCallService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
    ]; };
    ...
    return SendsmstoclientsComponent;
}());
...
var ViewclientsComponent = /** @class */ (function () {
    function ViewclientsComponent(apiCall, excelservice, router) {
        this.apiCall = apiCall;
        this.excelservice = excelservice;
        this.router = router;
        this.awaitingPersonList = [];
    ...
    ViewclientsComponent.prototype.selectAllToppings = function (checked, toppings) {
        this.selectedToppings = toppings;
        if (checked) {
            this.allToppings = true;
            this.selectedclients = this.selectedToppings;
    ...
    ViewclientsComponent.prototype.selectNewTopping = function (checked, topping) {
        if (checked) {
            this.selectedToppings.push(topping);
            this.selectedclients = this.selectedToppings;
        }
    ...
    ViewclientsComponent.prototype.selectclients = function () {
        var notify = confirm("Are you sure you want to send Bulksms");
        if (notify) {
            this.apiCall.getclientids(this.selectedclients);
            this.router.navigate(['/client/sendbulksms']);
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.getclientscount = function () {
        var _this = this;
        this.userService.getclientscount().subscribe(function (res) {
            _this.userdata = res.result[0];
        });
    };
    DashboardComponent.prototype.getuserdataCount = function () {
        var _this = this;
        this.userService.getuserdataCount().subscribe(function (res) {
            _this.newclients = res.result[0].NumberOfclients;
            console.log(_this.newclients);
        });
    };
    DashboardComponent.prototype.userdataCountweekly = function () {
        var _this = this;
        this.userService.userdataCountweekly().subscribe(function (res) {
            _this.newusersweekly = res.result[0].NumberOfclients;
        });
    };
    DashboardComponent.prototype.getplanexpirytoday = function () {
        var _this = this;
        this.userService.getplanexpirytoday().subscribe(function (res) {
            _this.planexpirytdy = res.result[0].NumberOfclients;
        });
    };
    DashboardComponent.prototype.getplanexpirynextweek = function () {
        var _this = this;
        this.userService.getplanexpirynextweek().subscribe(function (res) {
            _this.planexpiryweekly = res.result[0].NumberOfclients;
        });
    };
