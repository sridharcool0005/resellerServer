...
module.exports = "<form (ngSubmit)=\"regform.form.valid&&add(regform.form.value)\" #regform=\"ngForm\">\n  <div class=\"medias mymedia text-center border border-light p-5 \" >\n      <img src=\"assets/img/addsmspack.jpg\" width=\"25%\">\n\n        <input type=\"text\"  class=\"form-control mb-4\" placeholder=\"package Name\" name=\"package_name\" ngModel>\n        <input type=\"text\"  class=\"form-control mb-4\" placeholder=\"Route\" name=\"package_route\" ngModel >\n       <input type=\"text\"   class=\"form-control mb-4\" placeholder=\" unit price\" name=\"package_unit_price\" ngModel>\n      <input type=\"text\"   class=\"form-control mb-4\" placeholder=\"sms Credits \" name=\"package_sms_credits\" ngModel>\n      <input type=\"text\"   class=\"form-control mb-4\" placeholder=\"Gst Rate\" name=\"package_gst_rate\" ngModel>\n      <input type=\"text\"   class=\"form-control mb-4\" placeholder=\"Gst Amount\" name=\"package_gst_amount\" ngModel>\n      <input type=\"text\"   class=\"form-control mb-4\" placeholder=\"package price\t\" name=\"package_price\" ngModel>\n      <input type=\"text\"   class=\"form-control mb-4\" placeholder=\"package details\" name=\"package_details\" ngModel>\n      <input type=\"text\"   class=\"form-control mb-4\" placeholder=\"package Status\" name=\"package_status\" ngModel>\n      <input type=\"date\"   class=\"form-control mb-4\" placeholder=\"Validity\" name=\"package_validity_in_months\" ngModel>\n\n      <button mdbBtn color=\"info\" block=\"true\"  class=\"my-4\" type=\"submit\">Add</button>\n  </div>\n  </form>\n"
...
var AddPremiumPackComponent = /** @class */ (function () {
    function AddPremiumPackComponent(apiCall, router) {
        this.apiCall = apiCall;
        this.router = router;
        this.is_sim_allowed = "";
        this.is_min_bal_req = "";
    }
    AddPremiumPackComponent.prototype.ngOnInit = function () {
    };
    AddPremiumPackComponent.prototype.add = function (data) {
        var _this = this;
        this.apiCall.addPremiumPackage(data).subscribe(function (res) {
            console.log(res);
            alert('Package added successfully');
            _this.router.navigate(['/packagemanagement']);
        });
    };
    AddPremiumPackComponent.ctorParameters = function () { return [
        { type: src_app_apiCalls_api_call_service__WEBPACK_IMPORTED_MODULE_3__["ApiCallService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
    ...
    return AddPremiumPackComponent;
}());
...
var ApiCallService = /** @class */ (function () {
    ...
    ApiCallService.prototype.addPremiumPackage = function (data) {
